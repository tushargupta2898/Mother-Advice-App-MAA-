...
public class HighRiskAnm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDoalog = new ProgressDialog(HighRiskAnm.this);
    ...
    public void showList() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, commonapi + "highriskanm.php",
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            try {
                                ...
                                HighRiskAnm.UserListAdapter adapter = new HighRiskAnm.UserListAdapter(userlist, getApplicationContext());
        ...
        public View getView(final int position, View view, ViewGroup viewGroup) {
            ...
            verify_form.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent verify_next=new Intent(HighRiskAnm.this,AadharActivity.class);
            ...
            checkup_form.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent checkup_next=new Intent(HighRiskAnm.this,HealthCheckup.class);
