...
public class ParentAadhar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_parent_aadhar);
        a=(EditText)findViewById(R.id.parentwife_id_hint);
    ...
    private void InsertForm() {
        ...
        Log.d("OmSai:-", "start");
        StringRequest postRequest = new StringRequest(com.android.volley.Request.Method.POST, commonapi + "parentaadhar.php",
                new com.android.volley.Response.Listener<String>() {

                    @Override
                    public void onResponse(String response) {
                        Intent i=new Intent(ParentAadhar.this,Parent1Activity.class);
                        SharedPreferences prefs= getSharedPreferences("Aadhar", Context.MODE_PRIVATE);
                        SharedPreferences.Editor editor=prefs.edit();
                        editor.putString("parent_aadhar",aadhar);
                        editor.apply();
                        startActivity(i);
                        finish();
                ...
                new com.android.volley.Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        if (error instanceof NoConnectionError){
                            Toast.makeText(ParentAadhar.this,"Please Check your connection", Toast.LENGTH_SHORT).show();
                            pDialog.hide();
                        }
