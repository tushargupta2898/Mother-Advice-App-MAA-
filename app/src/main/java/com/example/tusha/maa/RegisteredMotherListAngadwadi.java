...
public class RegisteredMotherListAngadwadi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDoalog = new ProgressDialog(RegisteredMotherListAngadwadi.this);
    ...
    {
        StringRequest stringRequest=new StringRequest(Request.Method.POST, commonapi +"anganwadifilter.php",
