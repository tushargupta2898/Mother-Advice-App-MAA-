...
public class PlanningAadhar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_planning_aadhar);

        a=(EditText)findViewById(R.id.planningwife_id_hint);
    ...
    private void InsertForm() {
        ...
        Log.d("OmSai:-", "start");
        StringRequest postRequest = new StringRequest(com.android.volley.Request.Method.POST, commonapi +"planningaadhar.php",
                new com.android.volley.Response.Listener<String>() {

                    @Override
                    public void onResponse(String response) {
                        Intent i=new Intent(PlanningAadhar.this,Planning1Activity.class);
                        SharedPreferences prefs= getSharedPreferences("Aadhar", Context.MODE_PRIVATE);
                        SharedPreferences.Editor editor=prefs.edit();
                        editor.putString("plan_aadhar",aadhar);
                        editor.apply();
                        startActivity(i);
                ...
                new com.android.volley.Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        if (error instanceof NoConnectionError){
                            Toast.makeText(PlanningAadhar.this,"Please Check your connection", Toast.LENGTH_SHORT).show();
//                            pDialog.hide();
                        }
